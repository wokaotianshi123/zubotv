...
# 定义fofa链接
fofa_url = 'https://fofa.info/result?qbase64=InVkcHh5IiAmJiBjaXR5PSJ3dWhhbiI%3D'
...
if unique_ips_ports:
    ...
    if valid_ip:
        ...
        # 定义需要更新的文件列表
        files_to_update = [
            {'url': 'https://raw.githubusercontent.com/frxz751113/zubotv/main/HBDX/HBDX.txt', 'filename': 'txt/HBDX.txt'},
            {'url': 'https://raw.githubusercontent.com/frxz751113/zubotv/main/HBDX/HBDX.m3u', 'filename': 'm3u/HBDX.m3u'}
        ]
