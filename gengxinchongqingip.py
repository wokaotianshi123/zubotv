...
fofa_url = 'http://tonkiang.us/hoteliptv.php?page=1&pv=%E9%87%8D%E5%BA%86%E7%94%B5%E4%BF%A1'
...
# 定义组播地址和端口
urls_udp = "/udp/235.254.196.213:1124"
...
if unique_ips_ports:
    ...
    if valid_ip:
        ...
        # 定义需要更新的文件列表
        files_to_update = [
            {'url': 'https://gitjs.wokaotianshi123.cloudns.org/https://raw.githubusercontent.com/wokaotianshi123/zubotv/main/chongqing/chongqingzubo.txt', 'filename': 'chongqingzubo.txt'},
