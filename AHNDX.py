...
# 定义fofa链接
fofa_url = 'https://fofa.info/result?qbase64=YmFzZV9wcm90b2NvbD0idWRwIiAmJiBjb3VudHJ5PSJDTiIgJiYgcmVnaW9uPSJIdW5hbiI%3D'   #湖南
fofa_url = 'https://fofa.info/result?qbase64=InVkcHh5IiAmJiBjb3VudHJ5PSJDTiIgJiYgcmVnaW9uPSJIdW5hbiI%3D'   #湖南省
...
if unique_ips_ports:
    ...
    if valid_ip:
        ...
        # 定义需要更新的文件列表
        files_to_update = [
            {'url': 'https://raw.githubusercontent.com/frxz751113/zubotv/main/HBDX/HNDX.txt', 'filename': '湖南电信.txt'},
            {'url': 'https://raw.githubusercontent.com/frxz751113/zubotv/main/HBDX/HNDX.m3u', 'filename': 'BHNDX.m3u'}
        ]
