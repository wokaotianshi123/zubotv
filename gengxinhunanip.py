...
fofa_url = 'http://tonkiang.us/hoteliptv.php?page=1&pv=%E6%B9%96%E5%8D%97%E7%94%B5%E4%BF%A1'
...
# 定义组播地址和端口
urls_udp = "/udp/239.76.245.51:1234"
...
if unique_ips_ports:
    ...
    if valid_ip:
        ...
        # 定义需要更新的文件列表
        files_to_update = [
            {'url': 'https://gitjs.wokaotianshi123.cloudns.org/https://raw.githubusercontent.com/wokaotianshi123/zubotv/main/hunan/hunanzubo.txt', 'filename': 'hunanzubo.txt'},
            {'url': 'https://gitjs.wokaotianshi123.cloudns.org/https://raw.githubusercontent.com/wokaotianshi123/zubotv/main/hunan/hunanzubo.m3u', 'filename': 'hunanzubo.m3u'}
        ]
